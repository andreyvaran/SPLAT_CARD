...
data_root = "/home/lab_server/transfer_splat/data_detection/"
dataset_type = "YOLOv5CocoDataset"
deepen_factor = 1.0
default_hooks = dict(
    checkpoint=dict(interval=100, max_keep_ckpts=100, type="CheckpointHook"),
...
model = dict(
    ...
    bbox_head=dict(
        ...
        loss_cls=dict(
            beta=2.0, loss_weight=1.0, type="mmdet.QualityFocalLoss", use_sigmoid=True
        ),
...
test_evaluator = dict(
    ann_file="/home/lab_server/transfer_splat/data_detection/valid/_annotations.coco.json",
    metric="bbox",
    proposal_nums=(
        100,
        1,
